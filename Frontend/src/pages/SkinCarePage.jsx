...
const SkinCarePage = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        ...
        // ✅ Match DB category spelling exactly
        const skincare = responseData.filter(
          (item) => item.category?.toLowerCase() === "skin care products"
        );
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setItems((prevItems) => prevItems.filter((i) => i._id !== deleteItem._id));
