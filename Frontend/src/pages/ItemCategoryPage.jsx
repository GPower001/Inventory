...
//   const exportToExcel = () => {
//     const dataToExport = groupedProducts[activeCategory]?.map((product) => ({
...
//                 className="flex items-center justify-center bg-teal-500 text-white p-3 rounded-full shadow-lg hover:bg-teal-600 hover:text-white hover:scale-100 transition-transform"
//                 title="Export to Excel"
//             >
//                 <FaFileExcel size={18} /> {/* Reduced size */}
//             </button>
//             <button
//                 onClick={exportToWord}
//                 className="flex items-center justify-center bg-teal-500 text-white p-3 rounded-full shadow-lg hover:bg-teal-600 hover:scale-100 hover:text-white transition-transform"
//                 title="Export to Word"
//             >
//                 <FaFileWord size={18} /> {/* Reduced size */}
//             </button>
//         </div>
...
const ItemCategoryPage = () => {
  ...
  const categories = Object.keys(groupedProducts);
  const paginatedProducts = paginate(groupedProducts[activeCategory] || []);
  const totalPages = Math.ceil((groupedProducts[activeCategory]?.length || 0) / itemsPerPage);
