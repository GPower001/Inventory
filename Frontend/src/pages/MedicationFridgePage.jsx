...
//         // ✅ Match DB category exactly
//         const fridgeMeds = responseData.filter(
//           (item) => item.category === "Medication (Fridge)"
//         );
...
//       handleItemDelete(deleteItem._id);
//       setShowConfirm(false);
//       setDeleteItem(null);
//       showPopup("Item deleted successfully!");
//     } catch (err) {
//       console.error("Error deleting item:", err);
//       showPopup("Failed to delete item. Please try again.");
//     }
//   };
...
const Popup = ({ message, type, onClose }) => (
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <span>{message}</span>
      <button onClick={onClose} className="text-lg font-bold focus:outline-none">
        &times;
      </button>
    </div>
  </div>
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <StockTable
        ...
        handlePageChange={handlePageChange}
        totalPages={totalPages}
        onDeleteRequest={handleDeleteRequest} /* ✅ Fixed here */
        onEditName={handleEditName}
      />
